/*
  # Update Listing Visibility and Message Policies

  1. Changes
    - Allow public access to view listings and images
    - Require authentication for messaging
    - Keep email verification for sensitive operations
    
  2. Security
    - Public can view listings without authentication
    - Only authenticated users can send messages
    - Email verification still required for creating/updating listings
*/
